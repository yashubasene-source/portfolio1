...
(function () {
  ...
  /* ── REELS DATA (YouTube Playlist) ── */
    const MOTIONS = [
    {
      ...
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/PdRET3BPOEw/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/Hl6tbrqNzLA/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/rDedeIV_Aps/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/q4jkMc7PH5k/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/gfHHf6p3VrA/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/nPS2mbhDqY0/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/Q-z70AQ_LEM/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/Y9moP0Zoax8/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/GzTTDmcxJ3s/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/d6dCSs67AOI/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/BbWgPZrcxck/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/QAo0moIKqMg/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/g0ZplnuAQUM/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/coYHW222eFs/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/dsxddBiZ-Ek/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/kj55nEi4sYE/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/avDr-1331LU/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/I3fNfDbYT_M/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/0PmcMrtTJlM/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/XRrLmvfPpKM/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/D4qD8ZG4MIE/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/z1h96HEBA8g/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/4RDrmm_QBZw/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/_gVvYlMeuLw/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/4Ku6Ve7zIHY/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/V_V1EGIMNj0/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/He4asxOy3CQ/hqdefault.jpg',
    ...
    },
    {
      ...
      client: 'YouTube Shorts',
      ratio: 'ratio-9-16',
      img: 'https://img.youtube.com/vi/IqK1a7_fuTw/hqdefault.jpg',
  ...
  const GRAPHIC_FILES = [
    { file:'Sistec-01.webp',              title:'SISTEC Campaign — Visual 01',  client:'Educational Institute', ratio:'ratio-4-3',  tags:['Poster','Campaign'] },
    { file:'Sistec-02.webp',              title:'SISTEC Campaign — Visual 02',  client:'Educational Institute', ratio:'ratio-4-3',  tags:['Poster','Design'] },
    { file:'Artboard-1.webp',             title:'Brand Identity — Artboard',    client:'Brand Design',          ratio:'ratio-16-9', tags:['Branding','Identity'] },
    { file:'youphoria-psoter-1.webp',     title:'Youphoria Event Poster',       client:'Event Promoter',        ratio:'ratio-4-5',  tags:['Poster','Event'] },
    { file:'Day-1.webp',                  title:'Day-1 Campaign Visual',        client:'Social Media Campaign', ratio:'ratio-4-5',  tags:['Social Media','Brand'] },
    { file:'P-1.webp',                    title:'Premium Poster — P-1',         client:'Graphic Design Work',   ratio:'ratio-4-5',  tags:['Poster','Premium'] },
    { file:'Untitled-1.webp',             title:'Layout Design',                client:'Creative Brief',        ratio:'ratio-16-9', tags:['Layout','Design'] },
  ...
  /* ================================================
     HELPERS
  ================================================ */
  /* Use hqdefault (480x360, ~30KB) instead of maxresdefault (1280x720, ~180KB) — saves ~4MB on 34 video cards */
  function ytThumb(ytId) { return 'https://img.youtube.com/vi/' + ytId + '/hqdefault.jpg'; }
